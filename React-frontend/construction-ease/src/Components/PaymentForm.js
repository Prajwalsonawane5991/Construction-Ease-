...
const PaymentFormComponent = () => {
  ...
  <div className="row">
    <div className="h5 col-lg-8">
      ...
      <li>
                      ...
                      <ul>
                        <li style={{ color: "green" }}> - Bank Name:           HDFC Camp, Pune</li>
                        <li style={{ color: "green" }}> - Account Holder Name: ConstructionEase </li>
                        <li style={{ color: "green" }}> - Account Number:      HDFC0001405233</li>
                        <li style={{ color: "green" }}> - IFSC Code:           HOO49CP</li>
                      </ul>
                    </li>
      </div>
      ...
      <li>
                      ...
                      <ul>
                        <li style={{ color: "green" }}> - constructHome@ybl          </li>
  ...
  <div className="col-12">
    <div className="form__div">
      <input type="number" className="form-control" placeholder=" "  value={transactionId} onChange={(e) => setTransactionId(e.target.value)} />
  ...
  <div className="col-12">
  <button className="btn btn-primary w-100" type="submit">Submit</button><br></br><br></br>
  <div className="col-md-6 col-md-offset-3 text-center">
                  <Link to={`/`} className="btn btn-success btn-lg">Finish</Link>
                </div>
</div>
</form>
                    </div>
