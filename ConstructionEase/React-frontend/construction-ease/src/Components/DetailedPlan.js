...
const toggleDescription = () => {
  ...
  return (
    <div>
      <section className="md-section" id="id7" style={{ backgroundColor: "#fff", padding: "240px 70 0" }}>
        <div className="container">
          <div className="row gx-5">
            <aside className="col-lg-6">
            <div className="border rounded-4 mb-3 d-flex justify-content-center">
    <img
      src="assets/img/service/signin.jpg" // Corrected path to the image
      alt="Image Description" // Provide a descriptive alt text for accessibility
      className="rounded-4 fit" // Apply any necessary styling classes
      style={{ maxWidth: "100%", maxHeight: "100vh", margin: "auto" }} // Apply any necessary inline styles
    />
  </div>
  ...
  <div className="col-md-4 col-6">
    ...
    <p><strong>Username:</strong> {project.contractor.username}</p>
    <p><strong>Bio:</strong> {project.contractor.bio}</p>
  </div>
    ...
    <div className="d-flex align-items-center">
      ...
      <div>
        ...
        <p>Senapati Bapat road, Pune-413132</p>
                ...
                <a href="#" className="btn btn-primary shadow-0"> <i className="me-1 fa fa-shopping-basket"></i> Add to watchlist</a>
              </div>
            </main>
              ))}
          </div>
