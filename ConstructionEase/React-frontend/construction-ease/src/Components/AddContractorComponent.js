                ...
                <div className="col-lg-6 ">
                  <form className="contact-form">
                      ...
                      <div className="form-item">
											...
											<button className="btn btn-primary btn-round mb-30" type="submit" onClick={(e)=>saveOrUpdateContractor(e)}>Submit</button>

                      <button className="btn btn-primary btn-round mb-30" type="submit"  style={{  
