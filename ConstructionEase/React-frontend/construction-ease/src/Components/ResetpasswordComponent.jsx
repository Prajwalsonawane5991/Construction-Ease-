                ...
                <div className="col-lg-6 ">
                  <form className="contact-form text-center" onSubmit={(e1)=>reset(e1)}>
                    <div className="form-item">
                      <input className="form-control" type="text" name="text"  placeholder="Enter new password" required onChange={(e) => setPassword(e.target.value)} />
                      <br />
                      <br />
                     <input className="form-control" type="password" name="text"  placeholder="Confirm password" required onChange={(e) => setConfirmPassword(e.target.value)} />
                      <br />
